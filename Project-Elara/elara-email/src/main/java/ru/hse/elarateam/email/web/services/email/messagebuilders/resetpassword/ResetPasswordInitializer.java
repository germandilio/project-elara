...
@ToString
@Component
public class ResetPasswordInitializer {
    ...
    public ResetPasswordInitializer(
            ...
            @Value("${elara.mailiing-service.emails.reset-password.template-id}") int templateId,
            @Value("${elara.mailiing-service.emails.reset-password.action-url}") String actionUrl) {
    ...
    public ResetPasswordEmail init(String toEmail, String username, String token) {
        return new ResetPasswordEmail(fromEmail,
                productName,
                companyName,
                companyAddress,
                messageStream,
